...
mkdir -p "${XDG_CONFIG_HOME}"/{git/local,mc,htop,ranger,gem,zsh}
...
ln -sf "${SCRIPT_DIR}/configs/abbreviations" "${XDG_CONFIG_HOME}/zsh/abbreviations"
print "  ...done"
...
ln -snf "${SCRIPT_DIR}/env-wrappers/jenv/jenv/available-plugins/export" "${XDG_DATA_HOME}/jenv/plugins/export"
print "  ...done"
