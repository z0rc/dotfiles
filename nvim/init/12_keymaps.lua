...
vim.keymap.set('n', '<leader>ft', telescope_builtin.builtin, { desc = 'Select telescope' })
...
vim.keymap.set('n', '<leader>fs', require('schema-companion').select_schema, { desc = 'YAML/JSON Schema' })
